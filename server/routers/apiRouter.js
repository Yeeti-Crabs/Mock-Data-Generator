...
const {makeArray, getFirstName, getMiddleName } = require('../controllers/jsonController')
...
const controllers  = [makeArray, getFirstName, getMiddleName, getEmails, getPhoneNumbers]
